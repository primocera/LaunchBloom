...
// defaults use the Scalvya brand with clearly-marked placeholder legal
...
const BRAND = {
  ...
  name: process.env.BRAND_NAME || 'Scalvya',
  tagline: process.env.BRAND_TAGLINE || 'From Idea to Offer to Launch',

  // URLs
  siteUrl: process.env.BRAND_URL || 'https://scalvya.com',

  // Support + transactional email identity
  supportEmail: process.env.BRAND_SUPPORT_EMAIL || 'support@scalvya.com',
  senderName: process.env.BRAND_SENDER_NAME || 'Scalvya',
  senderEmail: process.env.BRAND_SENDER_EMAIL || 'hello@scalvya.com',
  ...
  legalName: process.env.BRAND_LEGAL_NAME || 'Scalvya (legal entity TBD)',
  legalAddress: process.env.BRAND_LEGAL_ADDRESS || '', // e.g. "123 Main St, Austin, TX 78701, USA"
  privacyEmail: process.env.BRAND_PRIVACY_EMAIL || process.env.BRAND_SUPPORT_EMAIL || 'support@scalvya.com',
...
/** "Scalvya <hello@scalvya.com>" for email `from` headers. */
function emailFrom() {
