  ...
  properties: {
    items: {
      ...
      items: {
        type: 'object',
        properties: {
          topic_cluster: { type: 'string', description: 'The content cluster/theme this idea belongs to.' },
          keyword: { type: 'string', description: 'Primary keyword idea (an idea, not researched search data).' },
        ...
        required: ['topic_cluster', 'keyword', 'secondary_keywords', 'search_intent', 'page_type', 'title', 'meta_description', 'content_angle', 'priority'],
        additionalProperties: false,
      },
    },
  },
